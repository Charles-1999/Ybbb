...
<body>
    ...
    <div class="nav">
        ...
        <div class="navitems fl">
            <ul>
                <li>
                    <a class="active" href="<%=request.getContextPath() %>/ticket">影讯&购票</a>
                </li>
                <li>
    ...
    <div class="main w">
        ...
        <div class="section-warp">
            <div class="title-warp">即将上映</div>
            <div class="item-warp">
                <c:forEach var="sk" items="${upcomingList}">
                    <div class="item">
                        <a href="<%=request.getContextPath() %>/details?id=${sk.id}">
                            ...
                            <span class="time">${sk.stime}上映</span>
                            <div class="buy">选票购座</div>
                        </a>
                    </div>
                </c:forEach>
            </div>
        ...
        <div class="section-warp">
            <div class="title-warp">正在上映</div>
            <div class="item-warp">
                <c:forEach var="sk" items="${nowList}">
                    <div class="item">
                        <a href="<%=request.getContextPath() %>/details?id=${sk.id}">
                            <div class="img"><img src="images/movie/${sk.id}.jpg" title="${sk.name}"></div>
                            <span class="title">${sk.name}</span>
