...
<body>
    ...
    <div class="main w">
        <div class="info-warp clearfix">
            <div class="left fl">
                <h1>${movie.name} <span class="time">(${movie.time})</span></h1>
                <div class="info">
                    <div class="post">
                        <img src="images/movie/${movie.id}.jpg" alt="">
                    </div>
                    <div class="details">
                        <div>导演：<span class="content">${movie.director}</span></div>
                        <div>编剧：<span class="content">${movie.writer}</span></div>
                        <div>主演：<span class="content">${movie.actor}</span></div>
                        <div>形式：<span class="content">${movie.form}</span></div>
                        <div>类型：<span class="content">${movie.type}</span></div>
                        <div>制片国家/地区：<span class="content">${movie.region}</span></div>
                        <div>语言：<span class="content">日语</span></div>
                        <div>上映日期：<span class="content">${movie.stime}</span></div>
                        <div>片长：<span class="content">${movie.duration}</span></div>
                    </div>
                </div>
                <div class="commentBtn clearfix">
                    <div class="left fl">
                        ...
                        <span>评价：</span>
                        <div class="stars"><img src="images/stars/star0.png" alt=""></div>
            ...
            <div class="right fl">
                <div class="title">歪比巴卜评分</div>
                <div class="rate">${movie.score}</div>
                <div class="stars">
                    <img src="images/stars/star3.png" alt="">
                </div>
            </div>
        </div>
        <div class="section">
                ...
                <c:forEach items="${commentList}" var="comment">
                    <div class="comment">
                        <div class="details">
                            <div class="user">
                                <div class="portrait">
                                    <a href="javascript:;"><img src="images/user/${comment.userId}.jpg" alt=""></a>
                                </div>
                                <div class="name">
                                    <a href="javascript:;">${comment.uName}</a>
                                </div>
                                <div class="stars">
                            ...
                            <div class="btn">
                                <span class="praise iconfont">&#xe605;</span>(${comment.praise})
                                <span class="bad iconfont">&#xe604;</span>(${comment.bad})
                                <span class="response">${comment.response}回应</span>
                            </div>
                        </div>
                    </div>
                </c:forEach>
