...
<body>
        ...
        <div class="w clearfix">
            ...
            <div class="navitems fl">
                <ul>
                    ...
                    <li>
                        <a class="active" href="<%=request.getContextPath() %>/movie">选电影</a>
                    </li>
                    <li>
    ...
    <div class="main w">
        <div class="hd">
            ...
            <div class="sort">
                <label>
                    <input type="radio" name="sort" id="hot" checked>按热度排序
                </label>
                <label>
                    <input type="radio" name="sort" id="time">按时间排序
                </label>
                <label>
                    <input type="radio" name="sort" id="comment">按评价排序
                </label>
            </div>
        </div>
        <div class="item-warp">
