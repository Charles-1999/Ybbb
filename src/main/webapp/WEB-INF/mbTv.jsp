...
<body>
    ...
    <div class="nav">
        <div class="nav-list">
            ...
            <div class="nav-item-c3 active"><a href="mbTv">电视剧</a></div>
        ...
        <div class="category-warp">
            <div class="warp-row">
                ...
                <div class="warp-right" id="form">
                    ...
                    <a href="javascript:;">真人秀</a>
                    <a href="javascript:;">喜剧</a>
                    <a href="javascript:;">韩剧</a>
                    <a href="javascript:;">日剧</a>
                    <a href="javascript:;">国产剧</a>
                    <a href="javascript:;">港剧</a>
                    <a href="javascript:;">日本动画</a>
