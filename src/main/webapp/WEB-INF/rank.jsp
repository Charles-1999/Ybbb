        ...
        <div class="w clearfix">
            ...
            <div class="navitems fl">
                <ul>
                    ...
                    <li>
                        <a class="active" href="<%=request.getContextPath() %>/rank">排行榜</a>
                    </li>
                    <li>
            ...
            <div class="movie-warp">
                <c:forEach var="movie" items="${movieList}" varStatus="i">
                    <div class="movie">
                        ...
                        <div class="info">
                            <a class="title"
                                href="<%=request.getContextPath() %>/details?id=${movie.id}">${movie.name}</a>
                            <div class="details">
            ...
            <div class="section">
                ...
                <div class="title-warp">
                    <c:forEach items="${movieList}" var="movie" varStatus="i">
                        <c:if test="${movie.region eq '美国'}">
                            <div class="title clearfix">
                                <a href="javascript:" class="fl name">${movie.name}</a>
                                <span class="fr"><span style="color:#e09015">${movie.score}</span>分</span>
                            </div>
                        </c:if>
                    </c:forEach>
                </div>
